'''
coloring spesific range in spesific chain, 
pymol : color yellow, resi 1-100 in chain B 
python: cmd.color('red', "2QBG and resi 1-100 in chain B") 
'''
import cmd
import csv
import urllib2

# pdb_file is the user input and can change:
pdb_file = '2QBG'
...
#cmd.color('red', "2QBG and resi 10-100 in chain A") 
